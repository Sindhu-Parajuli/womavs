                            ...
                            <div className={"row"}>
                                <div className="card" style={{width: width / 4, height: "100%"}}>
                                    <div className="col-lg-11" style={{marginBottom: 0, marginLeft: 10}}>
                                        {user.photoURL ? (
                                            <img src={user.photoURL} style={{marginTop: 10, marginBottom: 0}}
                                                 id={"propic"} className="card-img" alt="..."/>
                                        ) : (
                                            <img src={propic} style={{marginTop: 10, marginBottom: 0}} id={"propic"}
                                    ...
                                    <div className="col-lg-12">
                                        ...
                                        {user.displayName ? (
                                            <h2 className="card-title" id={"currUsername"}
                                                style={{marginLeft: "30%"}}>{user.displayName}</h2>
                                        ) : (
                                            <h2 className="card-title" style={{marginLeft: "30%"}}>Somewhere</h2>
                                        )}
                                        <div className={"card-body"}>
                                            <ul className={"list-unstyled"}>
                                                <li><Button variant="contained" color={"default"}
                                                            style={{marginBottom: 5}} onClick={() => setView(1)}>Edit
                                                    Profile</Button>{' '}</li>
                                                <li><Button variant="contained"
                                                            style={{marginBottom: 5, background: "#0064b1"}}
                                                            onClick={() => resetPass()}>Reset Passsword</Button>{' '}
                                                </li>
                                                <li><Button variant="contained" style={{background: "rgb(245,128,38)"}}
                                                            onClick={() => setStatus(true)}>Delete Account</Button>{' '}
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    {view == 1 ? (
                                        ...
                                        <div className={"col"}>
                                            ...
                                            <label style={{marginLeft: 10, marginTop: "40%", marginRight: 50}}>
                                                <Button variant="contained" color="default" onClick={() => cancelEdit()}
                                                        component="span">
                                                    Cancel
                                                </Button>
                                            </label>
                                            <label style={{marginLeft: 10, marginTop: "40%", marginRight: 50}}>
                                                <Button variant="contained" color="primary"
                                                        onClick={() => saveProfileEdit()} component="span">
                                                    Save
                                                </Button>
                                            </label>
                                        </div>
                                        ...
                                        <div className={"col-lg-10"} style={{position: "fixed"}}>
                                            <img src={backgroundImage} style={{width: width * .77, height: 300}}
                                                 alt={"..."}/>
                                        </div>)}
                                </div>
                            </div>
